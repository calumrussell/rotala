...
mod tests {
    ...
    fn setup() -> SingleBroker<Dividend, HashMapCorporateEventsSource, Quote, HashMapPriceSource> {
        ...
        price_source.add_quotes(101, Quote::new(14.00, 15.00, 101, "BCD"));

        price_source.add_quotes(102, Quote::new(95.00, 96.00, 102, "ABC"));
        price_source.add_quotes(102, Quote::new(10.00, 11.00, 102, "BCD"));

        price_source.add_quotes(103, Quote::new(95.00, 96.00, 102, "ABC"));
        price_source.add_quotes(103, Quote::new(10.00, 11.00, 102, "BCD"));
    ...
    fn test_that_broker_build_passes_without_trade_costs() {
        ...
        let mut price_source = HashMapPriceSource::new(clock.clone());
        price_source.add_quotes(100, Quote::new(100.00, 101.00, 100, "ABC"));
        price_source.add_quotes(100, Quote::new(104.00, 105.00, 101, "ABC"));
        price_source.add_quotes(100, Quote::new(95.00, 96.00, 102, "ABC"));
    ...
    fn test_that_broker_handles_negative_cash_balance_due_to_volatility() {
        ...
        let mut price_source = HashMapPriceSource::new(clock.clone());
        price_source.add_quotes(100, Quote::new(100.00, 101.00, 100, "ABC"));
        price_source.add_quotes(101, Quote::new(150.00, 151.00, 101, "ABC"));
        price_source.add_quotes(102, Quote::new(150.00, 151.00, 102, "ABC"));
